        ...
        >
          ...
          <ais-search-box>
            <div class="finder__header" slot-scope="{ currentRefinement, isSearchStalled, refine }">
              <div class="searchBox">
                <div>
                  <h1 class="text-gray-100 md:text-3xl text-2xl font-bold">FINDER</h1>
                  <ais-powered-by />
                </div>
                <div class="bg-white p-3 rounded-md shadow-xl mx-6 flex justify-between max-w-xl">
                  <input
                    class="w-full"
                    type="search"
...
import GreenSearch from "~/assets/GreenSearch";

export default {
  metaInfo: {
    title: "Finder"
  },
  components: { JoseFinderCard, FinderPaginator, GreenSearch },
  data: function() {
    return {
      numberRepos: 3,
